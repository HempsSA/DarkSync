...
def get_stylesheet(theme_name="Dark Blue"):
    ...
    return f'''QWidget{{background:{t["bg"]};color:{t["text"]};font-family:"Segoe UI",Arial;font-size:10pt}}QMainWindow{{background:{t["window_bg"]}}}QLabel#title{{font-size:20pt;font-weight:700;color:{t["title_text"]};padding:4px}}QLabel#sectionTitle{{font-size:12pt;font-weight:700;color:{t["title_text"]};padding:6px 2px}}QLabel#muted{{color:{t["muted"]};font-size:10pt}}QFrame#panel{{background:{t["panel_bg"]};border:1px solid {t["border"]};border-radius:12px}}QFrame#card{{background:{t["card_bg"]};border:1px solid {t["border"]};border-radius:14px}}QFrame#card[tone=green]{{border-color:{t["green"]}}}QFrame#card[tone=orange]{{border-color:{t["orange"]}}}QFrame#card[tone=red]{{border-color:{t["red"]}}}QFrame#card[tone=blue]{{border-color:{t["blue"]}}}QLabel#cardTitle{{color:{t["muted"]};font-size:10pt;font-weight:600}}QLabel#cardValue{{color:{t["title_text"]};font-size:26pt;font-weight:800}}QListWidget#dashboardList{{background:{t["input_bg"]};border:1px solid {t["border"]};border-radius:9px;padding:6px}}QLabel#scanCard{{background:{t["input_bg"]};border:1px solid {t["border"]};border-radius:8px;padding:9px;color:{t["title_text"]};font-weight:700}}QLineEdit,QComboBox,QSpinBox,QTimeEdit{{background:{t["input_bg"]};border:1px solid {t["border"]};border-radius:7px;padding:8px}}QLineEdit:focus,QComboBox:focus,QSpinBox:focus,QTimeEdit:focus{{border:2px solid {t["primary"]}}}QPushButton{{background:{t["button_bg"]};border:1px solid {t["border"]};border-radius:7px;padding:8px 14px;font-weight:600}}QPushButton:hover{{background:{t["button_hover"]}}}QPushButton#primary{{background:{t["primary"]};color:white}}QPushButton#primary:hover{{background:{t["primary"]}}}QTableView,QTableWidget{{background:{t["bg"]};alternate-background-color:{t["table_alt"]};border:1px solid {t["border"]};border-radius:10px;gridline-color:{t["button_bg"]};selection-background-color:{t["primary"]};selection-color:white}}QHeaderView::section{{background:{t["header_bg"]};color:{t["header_text"]};border:0;border-right:1px solid {t["border"]};padding:9px;font-weight:700}}QProgressBar{{background:{t["progress_bg"]};border:1px solid {t["border"]};border-radius:6px;text-align:center;min-height:20px;color:{t["text"]}}}QProgressBar::chunk{{background:{t["progress_chunk"]};border-radius:5px}}QTabWidget::pane{{border:1px solid {t["border"]};border-radius:8px;background:{t["bg"]}}}QTabBar::tab{{background:{t["tab_bg"]};color:{t["text"]};padding:10px 18px;border:1px solid {t["border"]}}}QTabBar::tab:selected{{background:{t["tab_selected"]};color:{t["title_text"]}}}QTabBar::tab:hover{{background:{t["button_hover"]}}}QToolBar{{background:{t["toolbar_bg"]};border-bottom:1px solid {t["toolbar_border"]};spacing:4px;padding:6px}}QToolBar QToolButton{{margin:2px;padding:7px 10px;border-radius:6px;background:transparent;border:none;color:{t["text"]}}}QToolBar QToolButton:hover{{background:{t["button_hover"]};color:{t["title_text"]}}}QMenuBar{{background:{t["toolbar_bg"]};border-bottom:1px solid {t["border"]}}}QMenuBar::item{{padding:8px 12px;color:{t["text"]}}}QMenuBar::item:selected{{background:{t["button_hover"]};color:{t["title_text"]}}}QMenu{{background:{t["card_bg"]};border:1px solid {t["border"]};padding:4px;color:{t["text"]}}}QMenu::item{{padding:8px 24px;color:{t["text"]}}}QMenu::item:selected{{background:{t["button_hover"]};color:{t["title_text"]}}}QStatusBar{{background:{t["status_bg"]};color:{t["status_text"]}}}'''
